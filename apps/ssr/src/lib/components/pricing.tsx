  ...
  return (
    <div className="mt-16 flex  flex-col items-center justify-center  text-white p-0">
      <div className="w-full max-w-5xl mx-auto text-center space-y-4">
        ...
        <div className="pt-8 flex md:justify-around flex-col md:flex-row gap-4 md:max-w-5xl mx-auto">
          {/* Free Plan */}
          <div className="md:pt-6 p   max-w-md">
            <Card className="flex py-6 px-3  text-left bg-black border-1 border-bg-muted text-white scale-95 transform ">
              ...
              <CardContent className="flex flex-col gap-2 ">
                ...
                <ul className="space-y-3 pt-2 text-white/90">
                  ...
                  <li className="flex items-start">
                    <Check className="h-5 w-5 mr-2 mt-0.5 flex-shrink-0 " />
                    <span> .xlsx file parsing and encoding for Excel spreadsheet AI</span>
                  </li>
                  {/* <li className="flex items-start">
                    <Check className="h-5 w-5 mr-2 mt-0.5 flex-shrink-0 " />
          ...
          <div className="max-w-lg">
            <Card className="flex py-6 px-3 flex-col  text-left bg-black border-1 border-muted-foreground/33 text-white relative overflow-hidden">
              <CardHeader className="pb-0 pt-0">
              ...
              <CardContent className="flex flex-col gap-2">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <div>
                      <span>Multi-step AI Chat, up to 800 requests/day</span>
                      <span className="ml-2.5 text-xs font-semibold bg-amber-500/75 px-2 pt-1 pb-1.25 rounded-full">
                        supercharged
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start ">
                    ...
                    <span className="">
                      Excel formula assistant AI
                      <span className="ml-2.5 text-xs text-  font-semibold bg-purple-400/60  px-2 pt-1 pb-1.25  rounded-full">
                        validation
                      </span>
                      <span className="ml-2 text-xs  font-semibold bg-sky-400/60  px-2 pt-1 pb-1.25 rounded-full">
                        tools
                      </span>
                    </span>
                  </li>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <span>
                        .xlsx file parsing and encoding for Excel spreadsheet AI
                        {/* <span className=" text-lg">📊</span> */}
                      </span>
                      <span className="ml-2.5 text-xs  font-semibold bg-teal-300/40  px-2 pt-1 pb-1.25 rounded-full">
                        advanced
                      </span>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start ">
                    ...
                    <span>
                      ...
                      <span className="ml-2.5 text-xs tracking-wide font-semibold bg-rose-400/68 px-2 pt-1 pb-1.25 rounded-full">
                        ASAP
                      </span>
                    </span>
                  </li>
                  <li className="flex items-center ">
                    ...
                    <span>
                      ...
                      <span className="ml-2.5 text-xs  font-semibold bg-blue-500/80 px-2 pt-1 pb-1.25 rounded-full">
                        coming soon
                      </span>
                    </span>
                  </li>
